...
const tourSchema = mongoose.Schema(
  {
    name: {
      ...
      //validate: [validator.isAlpha, 'Tour names must have only characters'], *Porém não deixa ter espaços no nome
    },
    slug: String,
    duration: {
      type: Number,
...
//   this.pipeline().unshift({ $match: { secretTour: { $eq: false || null } } });
//   next();
// });
